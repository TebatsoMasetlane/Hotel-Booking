...
import hotel1 from "../images/hotel_feture_1.jpg"
import hotel2 from "../images/hotel_feture_2.jpg"
import hotel3 from "../images/hotel_feture_3.jpg"
...
function index() {
  return (
	...
	<div id="fh5co-counter-div" class="fh5co-counters">
		<div class="container">
			<div class="row">
		...
		<div class="container">
			...
			<div class="row">
				<div class="feature-full-1col">
					<div class="image"style={{ backgroundImage: `url(${hotel1})` }}>
				...
				<div class="feature-full-2col">
					<div class="f-hotel">
						<div class="image" style={{ backgroundImage: `url(${hotel2})` }}>
							<div class="descrip text-center">
					...
					<div class="f-hotel">
						<div class="image" style={{ backgroundImage: `url(${hotel3})` }}>
							<div class="descrip text-center">
								<p><small>For as low as</small><span>$99/night</span></p>
							</div>
						</div>
				...
				<div class="tab-content-container">
					...
					<div class="tab-content" data-tab-content="tab2">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<img src={img2} class="img-responsive" alt="Image"/>
								</div>
								<div class="col-md-6">
									<span class="super-heading-sm">World Class</span>
					...
					<div class="tab-content" data-tab-content="tab4">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<img src={img4} class="img-responsive" alt="Image"/>
								</div>
								<div class="col-md-6">
									<span class="super-heading-sm">World Class</span>
					...
					<div class="tab-content" data-tab-content="tab5">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<img src={img5} class="img-responsive" alt="Image"/>
								</div>
								<div class="col-md-6">
									<span class="super-heading-sm">World Class</span>
					...
					<div class="tab-content" data-tab-content="tab6">
						<div class="container">
							<div class="row">
								<div class="col-md-6">
									<img src={img6} class="img-responsive" alt="Image"/>
								</div>
								<div class="col-md-6">
									<span class="super-heading-sm">World Class</span>
	...
	<div id="fh5co-blog-div">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-4">
					<div class="blog-grid"style={{ backgroundImage: `url(${img1})` }}>
				...
				<div class="col-md-4">
					<div class="blog-grid" style={{ backgroundImage: `url(${img2})` }}>
						<div class="date text-center">
							<span>09</span>
							<small>Aug</small>
						</div>
				...
				<div class="col-md-4">
					<div class="blog-grid" style={{ backgroundImage: `url(${img3})` }}>
						<div class="date text-center">
							<span>09</span>
							<small>Aug</small>
						</div>
