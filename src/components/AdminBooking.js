    ...
    <header>
        ...
        <div className="booking-home">
            <div className="history-header">
                <button className="btn-view-history" onClick={viewHistory}>Booking Confirmation</button>
            </div>
            <div className="history-body">
                <div className="bookings">
                    ...
                    <div className="booking-info">
                        ...
                        <div className="book-statuses">
                            <button className="confirm-status">Availabe</button>
                            <button className="panding-status">Not Available</button>
                        </div>
                    </div>
                </div>
                <div className="bookings">
                    ...
                    <div className="booking-info">
                        ...
                        <div className="book-statuses">
                            <button className="confirm-status">Available</button>
                            <button className="panding-status">Not Available</button>
                        </div>
                    </div>
                </div>
                <div className="bookings">
                    ...
                    <div className="booking-info">
                        ...
                        <div className="book-statuses">
                            <button className="confirm-status">Available</button>
                            <button className="panding-status">Not Availabe</button>
                        </div>
                    </div>
                </div>
            </div>
