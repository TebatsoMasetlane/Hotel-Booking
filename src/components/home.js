		...
		<header>
					...
					<nav >
						<a  href="#fh5co-hero">Home</a> | 
							...
							{/* <Link to={"./signup"}><button class="navBtn">Register</button> </Link> */}
							<Link to={"./login"}><button  class="navBtn">User</button></Link>
							<Link to={"./AdminLog"}><button  class="navBtn">Admin</button></Link>
		...
		<div  class="fullheight" style={{ backgroundImage: `url(${pic})` }}>
		   		...
		   		<div class="container">
		   					...
		   					<div class="desc1">
			   					...
			   					<p>
			   						<a href="#hotel" class="btn">Book Now</a>
			   					</p>
		   					</div>
		...
		<div class="container">
			<div class="row">
				<div id="availability">
					...
					<label for="date-start">Adult</label>
								<input type="number" class="form-control" id="date-start" />
								<label for="date-start">Children</label>
								<input type="number" class="form-control" id="date-start" />
								<select class="cs-select cs-skin-border">
									<option value="" disabled selected>Location</option>
									<option value="email">Cape Town</option>
									<option value="twitter">Polokwane</option>
									<option value="linkedin">Pretoria</option>
								</select>
							...
							<button class="checkAvailability">
								<span>Check</span>
								Availability
							</button>
			...
			<div class="row">
				...
				<div class="f-hotel">
					<div class="image" >
							<div class="descrip text-center">
								<p><small>For as low as</small><span>R200/Day</span></p>
							</div>
						</div>
				
					<div class="desc" style={{ backgroundImage: `url(${hotel1})` }}>
						<h3>Deluxe Room</h3>
						...
						<p><Link to="/login" class="btn btn-primary btn-luxe-primary">Book Now <i class="ti-angle-right"></i></Link></p>
					</div>
					</div>
				</div>
				...
				<div class="feature-full-2col">
					<div class="f-hotel">
						<div class="image">
							<div class="descrip text-center">
								<p><small>For as low as</small><span>R230/Night</span></p>
							</div>
						</div>
						<div class="desc" style={{ backgroundImage: `url(${hotel2})` }}>
							<h3>Superior Room</h3>
					...
					<div class="f-hotel">
						<div class="image">
							<div class="descrip text-center">
								<p><small>For as low as</small><span>R300/Night</span></p>
							</div>
						</div>
						<div class="desc" style={{ backgroundImage: `url(${hotel3})` }}>
							<h3>Premium Room</h3>
							<p>Pellentesque habitant morbi tristique senectus et netus ett mauada fames ac turpis egestas. Etiam euismod tempor leo, 
							in suscipit urna condimentum sed. </p>
							<p><Link to="/login" class="btn btn-primary btn-luxe-primary">Book Now <i class="ti-angle-right"></i></Link></p>
					...
					<div class="f-hotel">
						<div class="image">
							<div class="descrip text-center">
								<p><small>For as low as</small><span>R250/Day</span></p>
							</div>
						</div>
						<div class="desc" style={{ backgroundImage: `url(${hotel4})` }}>
							<h3>D’Morvie</h3>
